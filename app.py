...
class Funcionario(db.Model):
    ...
    lista = db.Column(db.String(20), nullable=False)  # favoritos ou excluidos
...
def ver_atualizacoes(funcionario_id):
    ...
    return render_template('ver_atualizacoes.html', funcionario=funcionario, atualizacoes=atualizacoes)
